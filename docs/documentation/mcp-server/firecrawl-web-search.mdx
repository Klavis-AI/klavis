            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "firecrawl": {
                        ...
                        "url": firecrawl_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a web scraping assistant that helps extract content and data from websites."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Scrape the homepage of a news website"}]
                })
