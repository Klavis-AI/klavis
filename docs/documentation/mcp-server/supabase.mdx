            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "supabase": {
                        ...
                        "url": supabase_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a database management assistant that helps with Supabase projects, SQL queries, and backend operations."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Create a new Supabase project for my e-commerce application"}]
                })
