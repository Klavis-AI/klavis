            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "google_drive": {
                        ...
                        "url": google_drive_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a file management assistant that helps organize and manage Google Drive files."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "List all files in my shared folder"}]
                })
