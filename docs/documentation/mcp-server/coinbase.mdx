            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "coinbase": {
                        ...
                        "url": coinbase_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a cryptocurrency assistant that helps manage Coinbase portfolios and data."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Show me current Bitcoin price"}]
                })
