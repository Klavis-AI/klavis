            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "perplexity": {
                        ...
                        "url": perplexity_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a research assistant that uses Perplexity's AI-powered search to find accurate, up-to-date information."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Search for the latest developments in artificial intelligence"}]
                })
