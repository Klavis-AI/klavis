            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "google_docs": {
                        ...
                        "url": google_docs_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a document management assistant that helps create and edit Google Docs."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Create a new project proposal document"}]
                })
