            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "google_sheets": {
                        ...
                        "url": google_sheets_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a spreadsheet assistant that helps manage Google Sheets data and automate spreadsheet tasks."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Create a new spreadsheet for tracking expenses"}]
                })
