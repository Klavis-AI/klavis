            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "klavis-reportgen": {
                        ...
                        "url": klavis_reportgen_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a report generation assistant that creates comprehensive web reports based on search queries."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Generate a market analysis report for electric vehicles"}]
                })
