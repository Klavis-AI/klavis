            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "salesforce": {
                        ...
                        "url": salesforce_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a sales assistant that helps manage Salesforce CRM data and sales processes."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Show me all open opportunities this month"}]
                })
