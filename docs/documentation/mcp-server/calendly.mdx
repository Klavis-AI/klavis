            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "calendly": {
                        ...
                        "url": calendly_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a scheduling assistant that helps manage Calendly appointments and calendar events."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "List all my upcoming scheduled events"}]
                })
