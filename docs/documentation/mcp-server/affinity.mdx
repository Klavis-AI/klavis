            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "affinity": {
                        ...
                        "url": affinity_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a CRM assistant that helps manage Affinity data."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Search for recent opportunities"}]
                })
