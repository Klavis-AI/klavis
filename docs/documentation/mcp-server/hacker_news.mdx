...
### 1. Create a Hacker News MCP Server
...
```json SDK Response
{
  ...
  "oauthUrl": "https://api.klavis.ai/oauth/hackernews/authorize?instance_id=<instance-id>"
}
```
</CodeGroup>
...
webbrowser.open(hacker_news_server.oauth_url)
```

```javascript TypeScript
// The OAuth URL is provided in the server response
console.log('OAuth URL:', hackerNewsServer.oauthUrl);

// Redirect user to authorize
window.location.href = hackerNewsServer.oauthUrl;
```
...
func main() {
    ...
    baseUrl := "https://api.klavis.ai/oauth/hackernews/authorize"
...
public class HackerNewsOAuth {
    public static void main(String[] args) {
        String instanceId = "<your-instance-id>";
        String authUrl = "https://api.klavis.ai/oauth/hackernews/authorize?instance_id=" +
