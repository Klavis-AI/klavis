          ...
          <Tab title="LangChain">
            ...
            async def main():
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are an advertising assistant that helps create and manage social media ad campaigns on Facebook, Instagram, and LinkedIn."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Create a new Facebook lead generation campaign"}]
                })
