          ...
          <Tab title="LangChain">
            ...
            async def main():
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are an email marketing assistant that helps send emails, manage audiences, and create broadcasts using Resend."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Send a welcome email to john@example.com"}]
                })
