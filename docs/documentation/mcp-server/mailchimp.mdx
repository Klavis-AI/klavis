            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "mailchimp": {
                        ...
                        "url": mailchimp_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are an email marketing assistant that helps manage Mailchimp campaigns and audiences."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Get all my email audiences and their subscriber counts"}]
                })
