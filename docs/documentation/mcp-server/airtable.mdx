            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "airtable": {
                        ...
                        "url": airtable_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a database assistant that helps manage Airtable data."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "List all records in my projects table"}]
                })
