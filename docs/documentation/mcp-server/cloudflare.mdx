            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "cloudflare": {
                        ...
                        "url": cloudflare_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a Cloudflare management assistant that helps configure CDN, security, and edge computing services."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "List all DNS records for my domain"}]
                })
