            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "quickbooks": {
                        ...
                        "url": quickbooks_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are an accounting assistant that helps manage QuickBooks data, including customers, invoices, payments, and financial reports."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Create a new customer named 'ABC Company' with email abc@company.com"}]
                })
