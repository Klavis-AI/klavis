          ...
          <Tab title="LangChain">
            ...
            async def main():
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are a video content analyst that helps extract and analyze YouTube video transcripts and metadata."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Get the transcript for this YouTube video: https://www.youtube.com/watch?v=dQw4w9WgXcQ"}]
                })
