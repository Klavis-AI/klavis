            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "mixpanel": {
                        ...
                        "url": mixpanel_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are an analytics assistant that helps track events and analyze user behavior through Mixpanel."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "Analyze user engagement for the past month"}]
                })
