            ...
            async def main():
                ...
                mcp_client = MultiServerMCPClient({
                    "openrouter": {
                        ...
                        "url": openrouter_server.server_url
                    }
                })
                ...
                agent = create_react_agent(
                    model=llm,
                    tools=tools,
                    prompt="You are an AI model management assistant that helps access and compare different AI models through OpenRouter."
                )
                
                # Use the agent
                result = await agent.ainvoke({
                    "messages": [{"role": "user", "content": "List available models and compare their pricing"}]
                })
