...
Here's an example to build AI Agent that integrates Strata with n8n to automate workflows in Gmail and Slack.

<iframe
  src="https://platform.twitter.com/embed/Tweet.html?id=1981729786067145053"
  width="550"
  height="600"
  frameBorder="0"
  allowFullScreen
